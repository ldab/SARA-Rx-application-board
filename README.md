# SARA-Rx application board
 ...
 SARA-Rx NB-IoT + Cat-M1 + GNSS application board
...
2. Point the `$(SDK)` @`.emProject` to where you have installed Nordic SDK, for example `C:\nRF\nRF5_SDK_16.0.0_98a08e2`
...
4. Open the SEGGER Embedded Studio project file located in ```code\ninab3\blank\ses\```
